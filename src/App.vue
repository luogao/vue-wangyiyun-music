  ...
  <div id="app"  class="container plr0">
    <div class="col-md-12 header ">
      ...
      <div class="pull-right">
        <span class="userCover"><router-link :to="{ name: 'Userinfo', params: { userId: $store.state.user._id ? $store.state.user._id : 0 }}"></router-link></span>
        <span v-if="!$store.state.isLogin"><router-link :to="{ name: 'Signup'}">Signup</router-link>/<router-link :to="{ name: 'Login'}">Login</router-link></span>
      </div>
    </div>
    <div class="col-md-3 leftSide plr0 ">
      <router-link :to="{ name: 'Recommend'}" class="leftLink">发现音乐</router-link>
      
      <div class="col-md-12 plr0 userFavlist">
        <p v-for="favlist in user.favPlayList">
