		...
		<div class="col-md-12 content">
			<div class="userInfo col-md-12">
				...
				<div class="favMusic col-md-12">
					...
					<div class="col-md-12">
						<div class="col-md-12 " v-for="fav in user.favMusic">
				...
				<div class="favlist col-md-12">
					...
					<div class="col-md-12">
						<div class="col-md-4 playlistCover" v-for="favList in user.favPlayList" >
...
export default {
  ...
  mounted: function(){
  	var vm = this;
	vm.$http.get(vm.apiUrl+vm.$route.params.userId)
	.then((response) => {
  ...
  methods:{
    ...
    updateUser: function(){
    	this.$http.post(this.updateUrl+this.user._id)
    		.then((response)=>{
    			console.log('success')
    		})
    		.catch((response)=>{
